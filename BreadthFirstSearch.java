 ...
 */
public class BreadthFirstSearch extends Thread {
     ...
     */
    public BreadthFirstSearch(Agent agent){
        this.agent = agent;
    ...
    /**
     * Starts the BFS Threads. One tries to find the goal, the other tries to 
     * get back home.
     */
    public void run() {
